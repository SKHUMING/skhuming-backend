...
//        Member member = memberService.memberSave(memberSaveReqDto);
//
////        System.out.println("member.getMemberId() = " + member.getMemberId());
////        System.out.println("member.getScore() = " + member.getScore());
////        System.out.println("member.getTier() = " + member.getTier());
...
//
////        List<NoticeResDto> noticeResDtos = memberService.scrapNoticeList(memberDto.getMemberId());
...
//
////        noticeResDtos = memberService.scrapNoticeList(memberDto.getMemberId());
////        for (NoticeResDto notices : noticeResDtos) {
////            System.out.println("notices.getNoticeId() = " + notices.getNoticeId());
////            System.out.println("notices.getTitle() = " + notices.getTitle());
////        }
